...
441 GOTO480
470 REM ***** DEF FND(D)
471 D0 = SQR((K(I,1)-S1)^2+(K(I,2)-S2)^2)
472 RETURN
475 REM ***** DEF FNR(R)
476 R0 = INT(RND(R)*7.98+1.01)
477 RETURN
480 REM INITIALIZE ENTERPRIZE'S POSITION
490 R=1:GOSUB475:REM R0=FNR(R)
491 Q1=R0
492 R=1:GOSUB475:REM R0=FNR(R)
493 Q2=R0:S1=R0:S2=R0
...
1040 R=1:GOSUB475:REM R0=FNR(R)
1041 G(I,J)=K3*100+B3*10+R0:NEXTJ:NEXTI:IFK9>T9THENT9=K9+1
1100 IFB9<>0THEN1200
1150 IFG(Q1,Q2)<200THENG(Q1,Q2)=G(Q1,Q2)+120:K9=K9+1
1160 R=1:GOSUB475:REM R0=FNR(R)
1161 B9=1:G(Q1,Q2)=G(Q1,Q2)+10:Q1=R0
1162 R=1:GOSUB475:REM R0=FNR(R)
1163 Q2=R0
1200 K7=K9:IFB9<>1THENX$="S":X0$=" ARE "
1230 PRINT"YOUR ORDERS ARE AS FOLLOWS:"
1240 PRINT"DESTROY THE";K9;"KLINGON WAR-
1241 PRINT"SHIPS WHICH HAVE INVADED THE"
1252 PRINT"GALAXY BEFORE THEY CAN ATTACK"
1253 PRINT"FEDERATION HEADQUARTERS ON"
1260 PRINT"STARDATE";T0+T9;"."
1261 PRINT"THIS GIVES YOU";T9;"DAYS.
1262 PRINT"THERE";X0$;B9;"STARBASE";X$
1263 PRINT"IN THE GALAXY FOR RESUPPLYING"
1264 PRINT"YOUR SHIP."
1280 PRINT
1300 I=RND(1)
...
1460 PRINT"YOUR MISSION BEGINS WITH YOUR"
1461 PRINT"STARSHIP LOCATED IN THE GALACTIC"
1470 PRINT"QUADRANT '";G2$;"'.":GOTO 1500
...
2990 R=1:GOSUB475:REM R0=FNR(R)
2911 R1=R0:IFRND(1)>=.6THEN3000
...
4480 GOSUB470:REM D0=FND()
4481 H=INT((H1/D0)*(RND(1)+2)):IFH>.15*K(I,3)THEN4530
...
6060 GOSUB 470:REM D0=FND()
6061 H=INT((K(I,3)/D0)*(2+RND(1))):S=S-H:K(I,3)=K(I,3)/(3+RND(0))
...
6140 R=1:GOSUB475:REM R0=FNR(R)
6141 R1=R0:D(R1)=D(R1)-H/S-.5*RND(1):GOSUB8790
...
8590 R=1:GOSUB475:REM R0=FNR(R)
8591 R1=R0
8592 R=1:GOSUB475:REM R0=FNR(R)
5993 R2=R0:A$="   ":Z1=R1:Z2=R2:GOSUB8830:REM IFZ3=0THEN8590
8600 RETURN
