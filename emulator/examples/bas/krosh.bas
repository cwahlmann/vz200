...
12 REM (0=NEUGIERIG,1=ANGRIFF,2-98=FRIEDLICH,99=TOT)
13 E0=0
14 REM E1=STATUS GRUBENGEIST
12 REM (0=NEBEL, 1=GESTALT, 2-4=RAETSEL, 5=ANGRIFF, 99=TOT)
13 E1=0
74 REM --- KAMPF ---
75 REM EL=LEBENSKRAFT
76 REM EA=ATTACKE, EP=PARADE
77 REM ER=RUESTUNG, ET=TREFFERPUNKTE
78 REM E$=NAME, EN$/EA$/ED$=ARTIKEL
80 REM ---START---
81 CLS:PRINT "WIE HEISST DU";
82 INPUT SP$
83 CLS
90 PRINT "WILLKOMMEN, ";SP$;" !"
91 PRINT
92 PRINT "DIES IST KROSH, DER ALPTRAUM"
93 PRINT "DEINER SCHLAFLOSEN NAECHTE."
94 PRINT
100 LM=30+RND(15):LE=LM
102 G=3+RND(3)
...
400 REM --- BACH ---
401 CLS: PRINT "EIN SCHMALER BACH PLAETSCHERT"
402 PRINT "AM WEG ENTLANG. HIER UND DA"
403 PRINT "SIEHST DU EIN PAAR FISCHE NAHE"
404 PRINT "DER WASSEROBERFLAECHE."
410 IF E0<2 OR E0>=99 THEN 580
411 PRINT "DER RABE FOLGT DIR UND SETZT"
412 PRINT "SICH AUF EINEN ZWEIG."
580 REM - WEGE
...
594 GOTO 590
600 REM --- RAND DER GRUBE ---
601 CLS
602 PRINT "DER WALD LICHTET SICH UND DU"
603 PRINT "KOMMST AN DEN RAND EINER"
604 PRINT "SANDIGEN GRUBE."
610 IF E0<2 OR E0>=99 THEN 750
611 PRINT "KRAAH! DER RABE ZIEHT EINEN"
612 PRINT "KREIS UND BEZIEHT POSITION AUF"
613 PRINT "EINEM BAUM AM RANDE DER"
614 PRINT "LICHTUNG."
750 REM - WEGE
751 PRINT:PRINT "ABGESEHEN VON EINEM SCHMALEN"
752 PRINT "WILDPFAD, DER WESTLICH INS"
753 PRINT "UNTERHOLZ FUEHRT, BLEIBT NUR"
754 PRINT "DER WEG ZURUCK NACH NORDEN."
755 PRINT "WOHIN MOECHTEST DU GEHEN, W"
756 PRINT "ODER N - ODER MOECHTEST DU IN"
757 PRINT "DIE GRUBE HINABSTEIGEN, G";
750 INPUT S$
761 IF S$="W" THEN 800:REM WILDPFAD
762 IF S$="N" THEN 200:REM LICHTUNG
763 IF S$<>"G" THEN 750
764 IF E0<2 AND E0>=99 THEN 2600: REM IN DER GRUBE
765 PRINT:PRINT "'KRAH', KRAECHZT DER RABE."
766 PRINT "'IN DIE GRUBE WILLST DU REIN -"
767 PRINT "WILLST DU DORT BEGRABEN SEIN?"
767 PRINT "KRAH! KRAH!!'"
768 PRINT:PRINT "WILLST DU TROTZDEM IN DIE GRUBE,J ODER N";
770 INPUT S$
771 IF S$="N" THEN 750
772 IF S$<>"J" THEN 770
773 PRINT:PRINT "'ICH HABE DICH GEWARNT, ";SP$;"!"
774 PRINT "ICH HABE DICH GEWARNT - KRAH!!'"
775 GOSUB 10100: REM PAUSE
779 GOTO 2600: REM IN DER GRUBE
800 REM --- WILDPFAD ---
...
2600 REM --- IN DER GRUBE ---

2700 REM KAMPF 
2701 EL=20:EA=11:EP=9:ER=1:ET=2
2702 E$="GRUBENGEIST":EN$="DER":EA$="DEN":ED$="DEM"
2703 GOSUB 10500: REM KAMPF
2704 IF EL<=0 THEN E1=99

2780 REM - WEGE
2781 PRINT "DU VERLAESST DIE GRUBE NACH"
2782 PRINT "NORDEN."
2783 GOSUB 10100:REM PAUSE
2789 GOTO 600: REM RAND DER GRUBE
10000 REM ---STATUS---
